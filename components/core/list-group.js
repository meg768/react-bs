  ...
  _createClass(ListGroup, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["tag", "flush", "className"]);
...
_defineProperty(ListGroup, "propTypes", {});

_defineProperty(ListGroup, "defaultProps", {
  tag: 'ul',
  flush: false
});
...
ListGroup.Item = function (props) {
  var tag = props.tag,
      ...
      other = _objectWithoutProperties(props, ["tag", "color", "disabled", "action", "active", "className"]);
  ...
  className = (0, _classnames.default)(className, _defineProperty({}, "list-group-item-".concat(color), color));
